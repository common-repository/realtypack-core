...
/**
 * Elementor single agent social widget.
 *
 * @since 1.0.0
 */
class RTPC_Controllers_Elementor_Widgets_Agent_Socials extends \Elementor\Widget_Base {
    ...
    /**
     * Register single agent social widget controls.
     *
     * @since 1.0.0
     * @access protected
     */
    ...
    /**
     * Render single agent social widget output on the frontend.
     *
     * @since 1.0.0
     * @access protected
     */
