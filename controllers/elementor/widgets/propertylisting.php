 ...
 * @since 1.0.0
 */
class RTPC_Controllers_Elementor_Widgets_PropertyListing extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Property Listing', 'realty-pack-core' );
    }
    ...
    protected function _register_controls() {
        ...
        foreach($wpl_users as $wpl_user) $wpl_users_options[$wpl_user->ID] = esc_html__($wpl_user->user_login.((trim($wpl_user->first_name) != '' or trim($wpl_user->last_name) != '') ? ' ('.$wpl_user->first_name.' '.$wpl_user->last_name.')' : ''), 'realty-pack-core');
        ...
        $this->add_control(
        	'sf_select_user_id', 
        	array(
        		'label' => esc_html__('User', 'realty-pack-core'),
        		'type' => \Elementor\Controls_Manager::SELECT,
	...
	*/
	protected function render() {
		...
		$instance = array (
			...
			'sf_select_user_id'          =>  $settings['sf_select_user_id'],
