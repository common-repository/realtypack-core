 ...
 * @since 1.0.0
 */
class RTPC_Controllers_Elementor_Widgets_Button extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('RTP Button', 'realty-pack-core');
    }
    ...
    public static function get_button_sizes() {
        return [
            ...
            //'sm' => __('Small', 'realty-pack-core'),
            'md' => __('Medium', 'realty-pack-core'),
            'lg' => __('Large', 'realty-pack-core'),
            //'xl' => __('Extra Large', 'realty-pack-core'),
        ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_tab(
	        ...
	        $this->add_control(
	        	'rtp_button_shape',
	        	[
	        		'label' => __('Shape 2', 'realty-pack-core'),
	        		'type' => \Elementor\Controls_Manager::COLOR,
	        		'separator' => 'before',
	        		'dafault' => '#6A11CB',
	        		'selectors' => [
			...
			<a id="{{ settings.rtp_button_button_css_id }}" class="elementor-button elementor-size-{{ settings.rtp_button_size }} elementor-animation-{{ settings.rtp_button_hover_animation }}" href="{{ settings.rtp_button_link.url }}" role="button">
				<span class="elementor-button-content-wrapper">
					...
					<span class="elementor-button-icon elementor-align-icon-{{ settings.icon_align }}">
						<i class="{{ settings.rtp_button_icon }}" aria-hidden="true"></i>
					</span>
					<# } #> -->
