...
/**
 * Elementor 'single agent property listing' widget.
 *
 * @since 1.0.0
 */
class RTPC_Controllers_Elementor_Widgets_Agent_PropertyListing extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Agent Property Listing', 'realty-pack-core' );
    }
