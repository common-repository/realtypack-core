...
<?php
	...
	function fetch_remote_file( $url, $post ) {
		...
		// temp url
		$temp_name = ltrim( strstr( $url, 'wp-content/uploads' ), 'wp-content/uploads/' );
		$upload_path = get_option( 'realty_pack_importer_attachment_media' );
		$upload_url =  wp_upload_dir()['basedir'] . basename( strstr( $url, 'wp-content/uploads' ) );
		$upload_path = $upload_path . '/media';

		if ( file_exists( $upload_path .'/' . $temp_name ) ) {
			$upload['file'] = $upload_path .'/' . $temp_name;
			$upload['url'] = $upload_url .'/' . $temp_name;
		} else {
